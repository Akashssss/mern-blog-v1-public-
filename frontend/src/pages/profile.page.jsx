...
import AnimtionWrapper from '../common/page-animation'
...
export default function ProfilePage() {
    ...
    const getBlogs = async ({ page = 1, user_id }) => {
        ...
        let { data } = await axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/search-blogs", {
            author: user_id,
            page
        });
    ...
    //todo : when we using dynamic route you have to reset the state whenever the parameters changes otherwise react don't rerender the state . (part3 4:44 modern web yt)
    useEffect(() => {
                            ...
                            <div className='flex gap-4 mt-2 '>
                                {
                                    profileId == username ?
                                        <Link
                                            ...
                                            className='btn-light rounded-md'>Edit Profile</Link> : ""
                                }
